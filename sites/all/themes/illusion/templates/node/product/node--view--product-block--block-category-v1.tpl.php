    ...
    <figure class="fp_item t_align_c d_xs_inline_b">
        ...
        <figcaption>
            ...
            <div class="im_half_container m_bottom_10">
                <p class="color_dark d_sm_block w_sm_full d_xs_inline_m w_xs_half_column fw_ex_bold half_column d_inline_m t_align_c tr_all animate_fctl fp_price with_ie"><?php if ($regular_price != ""): ?><s class="fw_normal color_grey"><?php echo strip_tags($regular_price); ?></s><?php endif; ?><?php echo strip_tags($price); ?></p>	
                <div class="half_column d_sm_block w_sm_full d_xs_inline_m w_xs_half_column t_sm_align_c t_xs_align_r d_inline_m t_align_r tr_all animate_fctr with_ie"></div>
            </div>
