            ...
            <div class="row relative">
                ...
                <aside class="col-lg-4 col-md-4 col-sm-4 m_top_5"<?php if (!$slideshow_layout): ?> id="scroll_sidebar"<?php endif; ?>>
                    <figure class="m_bottom_40 m_xs_bottom_30">
                        <h5 class="fw_light color_dark m_bottom_20">Review Details</h5>
                        <ul>
                            <li class="m_bottom_8">
                                <div class="m_bottom_8"><i class="fa fa-calendar"></i> Date: <span class="fw_light"><?php print format_date($node->created, 'custom', 'M d, Y'); ?></span></div>
                                <hr>
                            </li>
                            <?php if (isset($node->field_client['und']) && $node->field_client['und'][0]['value'] != ""): ?>
                                <li class="m_bottom_8">
                                    <div class="m_bottom_8"><i class="fa fa-building"></i> Venue: <span class="fw_light"><?php print $node->field_client['und'][0]['value']; ?></span></div>
                                    <hr>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <li class="m_bottom_8">
                                <div class="m_bottom_8">Category: <span class="fw_light color_purple"><?php print illusion_format_comma_field('field_review_category', $node); ?></span></div>
                                <hr>
                            </li>
                            <?php if (isset($node->field_project_tags['und']) && count($node->field_project_tags['und']) > 0) : ?>
                                <li class="m_bottom_8">
                                    <div class="m_bottom_8"><i class="fa fa-tag"></i> Tags: <span class="fw_light color_purple"><?php print illusion_format_comma_field('field_project_tags', $node); ?></span></div>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </figure>
                    ...
                    <div class="clearfix">
                        <a href="<?php print $node->field_link_demo['und'][0]['value']; ?>" class="button_type_2 color_purple d_block f_left tr_all fs_medium r_corners page_button f_sm_none m_sm_bottom_10 d_sm_inline_b">View Project</a>
                ...
                <section class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_30<?php if ($slideshow_layout): ?> snormal_size<?php endif; ?>">
                    <figure class="m_bottom_12">
                        <h5 class="fw_light color_dark m_top_20 m_bottom_20">Detailed Review</h5>
                        <div class="fw_light m_bottom_12">
                            <?php
                            hide($content['comments']);
                            hide($content['field_project_tags']);
                            hide($content['field_review_category']);
                            hide($content['field_skill']);
                            hide($content['field_image']);
                            hide($content['field_gallery']);
                            hide($content['field_video']);
        ...
        <div class="container clearfix">
            ...
            <div class="row">
                ...
                <section class="col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="clearfix">
                        <a href="<?php print $node->field_link_demo['und'][0]['value']; ?>" class="button_type_2 color_purple d_block f_left tr_all fs_medium r_corners page_button f_xs_none m_xs_bottom_10 d_xs_inline_b">View Project</a>
