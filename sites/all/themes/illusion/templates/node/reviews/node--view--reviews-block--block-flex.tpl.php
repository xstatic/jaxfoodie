...
<figure class="col-lg-12 col-md-12 col-sm-12" data-appear-animation="fadeInDown" data-appear-animation-delay="200">
    ...
    <div class="popup_wrap relative r_corners wrapper m_bottom_20 db_xs_centered">
        ...
        <div class="popup_buttons tr_all_long w_md_full t_md_align_c">
            <a href="<?php echo $image; ?>" data-group="web_design" data-title="<?php echo $title; ?>" class="jackbox icon_wrap_size_3 color_light n_sc_hover d_block circle f_left m_right_10 f_md_none d_md_inline_b">
                <i class="icon-plus"></i>
            </a>
    ...
    <figcaption>
        ...
        <p class="m_bottom_12">
            ...
            $summary_after = (strlen($summary) > 143) ? substr($summary, 0, 140) . '...' : $summary;
            echo $summary_after;
            ?>
        </p>
